...
\emph{first remove} a point \( a_0 : A \), and \emph{then adding} it back into the type.
...
except that we have to put some restrictions%
...
While we cannot prove it internally, we think of the wild category of containers as \( (\infty,1) \)-category
