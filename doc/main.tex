...
\citeauthor{AbbottEtAl2005DataDifferentiating} investigate functions missing an input \( f : A \setminus a \to B \).
They call the process of extend their domain to all of \( A \) \emph{grafting}.
We have seen that in the presence of higher types, removal is only well-behaved for isolated points.
We adjust the definitions accordingly, and show that this yields an induction principle for types
...
\begin{proposition}\label{graft-equiv}
  ...
  grafting has the following hold:
  \begin{enumerate}
