...
In \cite{AbbottEtAl2003DerivativesContainers}, \citeauthor{AbbottEtAl2003DerivativesContainers} consider a general adjunction \( \Blank \CTimes H \dashv [H, \Blank] \),
describing \enquote{\( H \)-shaped} holes.
\Autoref{derivative-adjunction-sets} shows that for \( H \JudgeEq \Id \), such an adjunction exists.
Iterating it, we can describe \( n \)-hole contexts at \( H \JudgeEq \Op{y}\Fin{n} \).
We conjecture that this holds also for set-truncated \( H \) with finitary positions,
