...
\begin{todo-block}
  It should not be hard to show\todo{Either do it or check who has done it}
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    we see that each fiber is equivalent to a (disjoint) sums of fibers over the constructors \( \Op{top} \) and \( \Op{below} \).
    But these are embeddings, hence any such fiber is a proposition.
  \end{proof}
\end{theorem}
