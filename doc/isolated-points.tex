...
\begin{lemma}\label{is-embedding-sigma-isolate}
  ...
  there is an equivalence of propositions \( \Op{fiber}_{\SigmaIsolate}(y) \simeq \Op{isIsolated}(a) \times \Op{isIsolated}(b) \).
  In particular, \( \SigmaIsolate_{A, B} \) is an embedding.
  \begin{proof}
