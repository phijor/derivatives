...
Types, however, model more that just discrete collections:
...
% perhaps in the style of the \enquote{Spartan MLTT} as used in the \href{https://www.cs.bham.ac.uk/~mhe/TypeTopology/index.html}{\texttt{TypeTopology}} development of \citeauthor{EscardocontributorsTypeTopology}.
...
\begin{problem}\label{sigma-remove}
  ...
  \begin{construction}
    ...
    Assume to the contrary that there is some \( p_b : (a_0 , b_0) = (a_0 , b) \).
    From this we obtain (dependent) paths \( p'_b : a_0 = a_0 \) and \( p''_b : b_0 =_{p_b^1} b \).
    Since \( a_0 = a_0 \) is a proposition, we know that \( p'_b = \Op{refl} \),
    hence \( b_0 = b \).
